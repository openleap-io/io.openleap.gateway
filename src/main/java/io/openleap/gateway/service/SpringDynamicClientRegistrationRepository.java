...
public class SpringDynamicClientRegistrationRepository implements ReactiveClientRegistrationRepository, Iterable<ClientRegistration> {
    Logger logger = LoggerFactory.getLogger(SpringDynamicClientRegistrationRepository.class);
    ...
    public SpringDynamicClientRegistrationRepository(ClientRegistrationDetails clientRegistrationDetails, Map<String, ClientRegistration> staticClients) {
